...
from .modeling import ImageEncoderViT3D, MaskDecoder3D, PromptEncoder3D, Sam3D, TwoWayTransformer3D
...
def build_sam3D_vit_b_final(checkpoint=None):
    return _build_sam3D_final(
        encoder_embed_dim=768,
        encoder_depth=12,
        encoder_num_heads=12,
        encoder_global_attn_indexes=[2, 5, 8, 11],
...
sam_model_registry3D = {
    ...
    "vit_b_final": build_sam3D_vit_b_final,
}
