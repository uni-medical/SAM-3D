...
if __name__ == "__main__":
    ...
    # image_embeddings = torch.randn(1,768,16,16,16)
    # image_pe = torch.randn(1,768,16,16,16)
    # sparse_prompt_embeddings = torch.randn(1,2,768)
    # dense_prompt_embeddings = torch.randn(1,768,16,16,16)
