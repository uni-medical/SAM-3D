...
parser.add_argument('--step_size', type=list, default=[200, 400])
...
class BaseTrainer:
    ...
    def interaction(self, sam_model, image_embedding, gt3D, num_clicks):
        ...
        return prev_masks, (sum(dice_list)/len(dice_list)).item()  
    ...
    def train_epoch(self, epoch, num_clicks):
        ...
        for step, (image3D, gt3D) in enumerate(tbar):
            ...
            prev_masks, dice = self.interaction(sam_model, image_embedding, gt3D, num_clicks)
